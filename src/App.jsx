...
const App = () => {
  ...
  return (
    <div>
      <div className="md:px-20 relative  w-full my-[0] mx-[auto] bg-black-gradient text-white font-[poppins] overflow-hidden ">
        <a
          href="#"
          className="text-5xl fixed bottom-9 right-5 z-[500] sm:hidden opacity-70"
        >
          👆
        </a>
